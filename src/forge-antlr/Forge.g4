...
testDecl: (name COLON_TOK)? (qualName | block) scope? (FOR_TOK bounds)? IS_TOK (SAT_TOK | UNSAT_TOK | THEOREM_TOK | CHECKED_TOK | FORGE_ERROR_TOK);
...
expr4: expr5 | expr4 AND_TOK expr5;
expr5: expr6 | NEG_TOK expr5;
...
expr15: expr17 | expr15 DOT_TOK expr17 | name LEFT_SQUARE_TOK exprList RIGHT_SQUARE_TOK;
